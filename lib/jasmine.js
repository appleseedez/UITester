...
jasmine.ExpectationResult.prototype.toHTML = function (){

};

jasmine.ExpectationResult.prototype.toJSON = function (){
...
var expect = function (actual) {
    console.log(jasmine.getEnv().currentSpec)
...
jasmine.Matchers.wrapInto_ = function (prototype, matchersClass) {
    for (var methodName in prototype) {
        ...
        if( methodName.match(/^will/) ){
            matchersClass.prototype[methodName]  = orig;
        }else{
...
jasmine.NestedResults.prototype.toJSON = function () {

};

jasmine.NestedResults.prototype.toHTML = function () {
 ...
 * @return {string}
 */
jasmine.Spec.prototype.toJson = function(){
 ...
 * return {string}
 */
jasmine.Spec.prototype.toHTML = function(){
...
/**
 *  新的异步测试方法.传入操作函数.返回一个matcher
 *  这个matcher的actual是空的. 需要调用比较方法时将actual传入
 * @param mathersFunc
 * @return {Matcher}
 */
jasmine.Spec.prototype.waitsMatchers = function (mathersFunc, timeout) {
    ...
    if (!(mathersFunc && mathersFunc.apply)) {
        throw new Error("期望第一个参数是一段可以执行的代码");
    }
 ...
 * @return {string}
 */
jasmine.Suite.prototype.toJson = function(){
 ...
 * return {string}
 */
jasmine.Suite.prototype.toHTML = function(){
...
jasmine.WaitsForMatchers.prototype.execute = function (onComplete) {
    ...
    if (latchFunctionResult) {
        ...
        for (var p in this.messageArray) {
           // console.log("show message",this.messageArray[p])
