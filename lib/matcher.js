...
function printStackTrace(error){
    ...
    // opera
    else if (window.opera && error.message){
    ...
    if(!isCallStackPopulated) {
        ...
        while(currentFun){
            ...
            var fnName = fn.substring(fn.indexOf('function')+8,fn.indexOf(''))  ||'anonymous';
    ...
    var uiMatchers = {
        ...
        atPosition:function(x,y,off,relativeEl){
            ...
            if(arguments[3]&& typeof arguments[3] == 'string'){
                ...
                if(referEl){
                   referPosition = S.DOM.offset(referEl);
                }
